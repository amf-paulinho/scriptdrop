defmodule ScriptdropWeb.ProviderControllerTest do
  use ScriptdropWeb.ConnCase

  alias Scriptdrop.Logistic

  @create_attrs %{address: "some address", name: "some name", role: 42}
  ...
  def fixture(:provider) do
    {:ok, provider} = Logistic.create_provider(@create_attrs)
    provider
  end
