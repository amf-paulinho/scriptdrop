defmodule ScriptdropWeb.ClientController do
  ...
  def index(conn, _params) do
    clients = Global.list_clients()
    render(conn, "index.html", clients: clients)
  end

  def new(conn, _params) do
    changeset = Global.change_client(%Client{})
    render(conn, "new.html", changeset: changeset)
  end

  def create(conn, %{"client" => client_params}) do
    case Global.create_client(client_params) do
      {:ok, client} ->
        conn
  ...
  def update(conn, %{"id" => id, "client" => client_params}) do
    ...
    case Global.update_client(client, client_params) do
      {:ok, client} ->
        conn
  ...
  def delete(conn, %{"id" => id}) do
    client = Global.get_client!(id)
    {:ok, _client} = Global.delete_client(client)
